...
- [ ] Проверил локально через VS Code Live Preview
- [ ] Если публикуем продакшн — перенёс актуальный `index.html` в Tilda Members
...
- **Редактировать только blocks/** без `index.html` — Tilda-страница и локальное превью разойдутся
