...
const popupTemplate = fs.readFileSync(
  path.join(projectDir, '..', 'professional-barista', 'tilda-blocks', '09-online-booking-popup.html'),
  'utf8'
);
...
const bookingPopup = popupTemplate
  .replaceAll('mbs-pr-booking', 'mbs-sa-booking')
  .replaceAll('Профессиональный курс бариста', 'Сенсорный анализ кофе')
  .replaceAll('профессиональный курс бариста', 'сенсорный анализ кофе')
  .replaceAll('professional-barista-20260822', 'sensory-analysis-20260822')
  .replaceAll('professional-barista', 'sensory-analysis');

writeBlock('01-hero-and-for-whom.html', `${assets}\n<style>\n${tildaCss}\n</style>\n<div class="mbs-ad-page mbs-sa-page">\n${hero}\n</div>`);
writeBlock('02-course-content.html', `<div class="mbs-ad-page mbs-sa-page">\n${content}\n</div>\n${lightbox}`);
