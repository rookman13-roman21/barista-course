...
const mainContent = between(sourceHtml, '  <main class="mbs-alt-page">\n', '\n  </main>', 'основные блоки');
const programStart = mainContent.indexOf('    <section class="mbs-alt-program"');
if (programStart === -1) throw new Error('Не удалось найти начало блока программы');

const previewModalStart = sourceHtml.indexOf('  <div class="mbs-alt-modal"');
const lightboxStart = sourceHtml.indexOf('  <div class="mbs-alt-gallery-lightbox"');
