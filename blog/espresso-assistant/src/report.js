...
function reportStyles() {
  return `
    ...
    *{box-sizing:border-box} body{margin:0;background:#eef3ec;color:#1f2920}
    ...
    @media print{html,body{width:100%;height:auto!important;overflow:visible!important;background:#fff!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}.ea-report-toolbar{display:none!important}.ea-report-page{display:block;width:100%!important;max-width:100%!important;margin:0;padding:0;box-shadow:none}.ea-report-summary{grid-template-columns:repeat(4,minmax(0,1fr));break-inside:avoid}.ea-report-brand{break-inside:avoid}.ea-report-session-head>*,.ea-report-brand>*{min-width:0}.ea-report-footer{position:static;margin-top:8mm}}
