...
function reportStyles() {
  return `
    ...
    *{box-sizing:border-box} body{margin:0;background:#eef3ec;color:#1f2920}
    ...
    .ea-report-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin:14px 0}.ea-report-meta div{min-width:0;padding:9px;border:1px solid #d8e2d5;border-radius:9px}.ea-report-meta dt{color:#697469;font-size:8px}.ea-report-meta dd{margin:3px 0 0;font-weight:700;font-size:9px;overflow-wrap:anywhere}
    ...
    table{width:100%;max-width:100%;border-collapse:collapse;table-layout:fixed;font-size:8px}thead{display:table-header-group}th{padding:7px 6px;background:#417033;color:#fff;text-align:left}th:nth-child(1){width:12%}th:nth-child(2),th:nth-child(3),th:nth-child(4),th:nth-child(5),th:nth-child(6){width:8%}th:nth-child(7){width:32%}th:nth-child(8){width:16%}
    ...
    @page{size:297mm 210mm;margin:12mm 10mm 16mm}
    @media print{html,body{height:auto!important;overflow:visible!important;background:#fff!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}.ea-report-toolbar{display:none!important}.ea-report-page{display:block;width:277mm!important;min-width:0!important;max-width:277mm!important;margin:0!important;padding:0;box-shadow:none}.ea-report-summary{grid-template-columns:repeat(4,minmax(0,1fr));break-inside:avoid}.ea-report-brand{break-inside:avoid}.ea-report-session-head>*,.ea-report-brand>*{min-width:0}.ea-report-footer{width:277mm!important;max-width:277mm!important;position:static;margin-top:8mm}}
