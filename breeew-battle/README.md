...
- Лимит участников: `20`
- Площадка чемпионата: `Московская школа бариста, м. Бауманская, ул. Нижняя Красносельская, 35, стр. 50` (карта: `https://yandex.ru/maps/org/206204133172`).
- Адрес проведения совпадает с адресом выдачи кофе для подготовки, но в Mini App это два отдельных организационных блока: площадка и инструкция по получению кофе.
