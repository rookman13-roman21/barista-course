...
- **Последний важный контекст:** рабочая ветка может быть `work/excu-local-page` — проверять перед задачами; незакоммиченные хвосты — см. `mbs-design-system/WORK_IN_PROGRESS.md`.
