...
1. В head страницы вставить `00-seo.html` и задать Title страницы:
   `Продвинутый курс бариста в Москве — 18 часов практики | MBS`.
...
только slug `advanced-barista` общему виджету `course-booking-widget.js`: не
добавлять в этот файл токены, yClients URL или логику создания записи.

Блок тренеров не копируется в `advanced-barista`: это самостоятельный
