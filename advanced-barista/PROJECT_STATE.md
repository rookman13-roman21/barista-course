...
- Статус: backend записи и публичное расписание выложены; Tilda-страница не
  опубликована.
...
Tilda-блоки ещё не вставлены, текущая `/probarista` не менялась. Для выхода
страницы в production нужна отдельная ручная публикация в Tilda.
